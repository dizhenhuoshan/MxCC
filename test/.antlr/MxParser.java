// Generated from /home/wymt/Code/Compiler2019/MxCompiler/test/Mx.g4 by ANTLR 4.7.1
...
public class MxParser extends Parser {
	...
	private static final String[] _LITERAL_NAMES = {
		...
		"'++'", "'--'", "'+'", "'-'", "'!'", "'~'", "'*'", "'/'", "'%'", "'<<'", 
		"'>>'", "'<='", "'>='", "'<'", "'>'", "'=='", "'!='", "'&'", "'^'", "'|'", 
		"'&&'", "'||'", "'bool'", "'int'", "'string'", "'null'", "'void'", "'for'", 
		"'if'", "'else'", "'while'", "'break'", "'continue'", "'return'", "'new'", 
		"'class'", "'this'"
	};
	private static final String[] _SYMBOLIC_NAMES = {
		...
		"Null", "Void", "For", "If", "Else", "While", "Break", "Continue", "Return", 
		"New", "Class", "This", "ConstBool", "ConstIntenger", "ConstString", "Identifier", 
