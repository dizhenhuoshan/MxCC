...
public class MxParser extends Parser {
	...
	public static class FunctionStatementContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MxListener ) ((MxListener)listener).enterFunctionStatement(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MxListener ) ((MxListener)listener).exitFunctionStatement(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MxVisitor ) return ((MxVisitor<? extends T>)visitor).visitFunctionStatement(this);
			else return visitor.visitChildren(this);
		}
	}
		...
		try {
			...
			case For:
				...
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__4) | (1L << T__10) | (1L << T__11) | (1L << T__12) | (1L << T__13) | (1L << T__14) | (1L << T__15) | (1L << Null) | (1L << New) | (1L << This) | (1L << ConstIntenger) | (1L << ConstString) | (1L << ConstBool) | (1L << Identifier))) != 0)) {
					{
					setState(135);
					((LoopStatementContext)_localctx).start = expression(0);
					}
				}
				...
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__4) | (1L << T__10) | (1L << T__11) | (1L << T__12) | (1L << T__13) | (1L << T__14) | (1L << T__15) | (1L << Null) | (1L << New) | (1L << This) | (1L << ConstIntenger) | (1L << ConstString) | (1L << ConstBool) | (1L << Identifier))) != 0)) {
					{
					setState(139);
					((LoopStatementContext)_localctx).stop = expression(0);
					}
				}
